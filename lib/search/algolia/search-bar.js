// Helper
  ...
  $(function() {
    ...
    $("#inputfield input").autocomplete(null, {
      source: index.ttAdapter({ hitsPerPage: 20 }),
      displayKey: 'title',
      debug: true,
      templates: {
        suggestion: function(item) {
          ...
          // var test = item._highlightResult.title.matchedWords;
          // if (test.length == 0) {
          ...
          // console.log(item._snippetResult.content.value);
          var snippet = item._snippetResult.content.value;
